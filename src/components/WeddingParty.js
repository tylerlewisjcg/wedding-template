    ...
    <div>
      ...
      <div className="which_side">
        <div className="wedding_party">
          <p>Lauren Alvarez</p>
          <img src={LaurenAlvarez} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Abby Johnston</p>
          <img src={AbbyJohnston} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Averi Hooper</p>
          <img src={AveriHooper} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Avery Smith</p>
          <img src={AverySmith} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Kami Walker</p>
          <img src={KamiWalker} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Layklynn Eshmeyer</p>
          <img src={LayklynnEshmeyer} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Margaret Mackin</p>
          <img src={MargaretMackin} width="200px" alt="" />
        </div>
      </div>
      ...
      <div className="which_side">
        ...
        <div className="wedding_party">
          <p>Karson Lloyd</p>
          <img src={KarsonLloyd} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Weston Clements</p>
          <img src={WestonClements} width="200px" alt="" />
        </div>

        <div className="wedding_party">
          <p>Ian Clements</p>
          <img src={IanClements} width="200px" alt="" />
        </div>
